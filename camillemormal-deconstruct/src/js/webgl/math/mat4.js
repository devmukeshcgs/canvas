...
export function invert(t, e) {
    ...
    return (
        ...
        (t[8] = l * (H * n + P * g + E * m - (F * n + G * g + B * m))),
        (t[9] = l * (F * s + z * g + B * k - (H * s + P * g + E * k))),
        (t[10] = l * (G * s + P * l + D * k - (H * l + z * l + B * k))),
        (t[11] = l * (B * s + E * l + P * d - (G * s + B * l + D * d))),
        (t[12] = l * (G * d + B * m + E * u - (H * d + P * m + F * u))),
        (t[13] = l * (P * i + H * m + F * k - (G * i + B * m + E * k))),
        (t[14] = l * (B * i + G * h + D * k - (P * i + H * h + F * k))),
        (t[15] = l * (E * i + F * h + H * p - (B * i + G * h + D * p))),
        t
    );
}
...
export function multiply(t, e, i) {
    var s = e[0],
        r = e[1],
        a = e[2],
        h = e[3],
...
export function translate(t, e, i) {
    var s,
        r,
        a,
        h,
